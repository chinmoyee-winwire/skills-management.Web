...
export class SkillManagementService {
  ...
  getAllPractices(): Observable<any> {
    return this.httpClient.get(this.skillManagementAPIUrl + '/Practices/Get')
  ...
  getAllCategories(practiceId:any): Observable<any> {
    return this.httpClient.get(this.skillManagementAPIUrl + '/Categories/Get?practicesId=' + practiceId)
  ...
  getAllTechnology(): Observable<any> {
    return this.httpClient.get(this.skillManagementAPIUrl + '/TechnologyStack/GetTechnologyStack')
  ...
  getProficiencyLevel(): Observable<any> {
    return this.httpClient.get(this.skillManagementAPIUrl + '/ProficiencyLevel/Get')
